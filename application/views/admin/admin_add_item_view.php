...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="list-group">
            <a href="<?php echo site_url('admin/item'); ?>" class="list-group-item">Fixed & Consumable Items</a>
...
<!-- end of modal -->
    ...
    <div class="col-md-9">
        <div class="panel panel-primary" id="panels">
             ...
             Add Items <button class="btn btn-default pull-right" data-toggle="modal" data-target=".bs-example-modal-sm2">Add Supplier</button><button class="btn btn-default pull-right" data-toggle="modal" data-target=".bs-example-modal-sm">Add Department</button>
          </div>
            <div class="panel-body">
              <?php
                  $attributes = array('class' => 'form-horizontal');
                  echo form_open('admin/add_item_validate', $attributes);
            ?>
                                ...
                                <div class="row">
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input size="30" id="unit" name="item_unit" type="text" placeholder="" class="input-xlarge" required>
