       ...
       <table id="accounts-view" class="table table-bordered">
        ...
        <tbody>
          ...
          <tr> 
            ...
            <th>{price}</th>
            <th>{subtotal}.00</th>
            <th><a class="label label-danger" href="remove_item_po_c/{id}/">Remove</a></th>  
          </tr>
          {/cart_data}
          <tr>
          <td colspan="4"></td>
...
<div class="text-center col-md-12" >
  <a href="<?php echo site_url('admin/add_item_supp_cons'); ?>" class="btn btn-lg btn-info">Add supply</a> 
  <a href="<?php echo site_url('admin/clear_form_supp_c'); ?>" class="btn btn-lg btn-danger">Clear form</a> 
</div>
          </div>
   </div>
  </div>
...
<script type="text/javascript">
    ...
    $('#accounts-view').dataTable( {
        "aaSorting": [[ 0, "desc" ]],
        "bProcessing": true,
        "sAjaxSource": "<?php echo site_url('admin/datatables_supplier_c/{supplier_id}'); ?>",
        "aoColumnDefs": [
            {
...
<div id="add" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('admin/add_supplier_c_qty')?>" method="POST">
