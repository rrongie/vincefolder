...
<div class="row">
  <div class="col-md-3">
    ...
    <div class="list-group">
            ...
            <a href="<?php echo site_url('admin/consumable'); ?>" class="list-group-item ">Consumable Item List</a>
   ...
   <div class="col-md-9">
    <div class="panel panel-primary" id="panels">
         ...
         <div class="panel-heading">Consumable Item Details</div>
          <div class="panel-body">
             
                                    <?php echo form_open('admin/edit_consumable_validate/'.$this->uri->segment(3));?>
<!-- body -->
          <div class="row">   
            <?php
