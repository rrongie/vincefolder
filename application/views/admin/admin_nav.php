    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul style="color: white; " class="nav navbar-nav">
          <li style="font-size:15px; margin-top:5px;"><a href="<?php echo base_url('admin/consumable'); ?>">ITEMS</a></li>
           <li class="dropdown" style="font-size:15px; margin-top:5px;">
              ...
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop1">
                ...
                <li role="presentation"><a style="font-size:15px; margin-top:5px;" role="menuitem" tabindex="-1" href="<?php echo site_url('admin/borrowers'); ?>">BORROWER'S LIST</a></li>
